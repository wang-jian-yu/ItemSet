...
<body>
	<div class="container">
		...
		<form id="bookAddForm" class="form-horizontal" action="jsp/admin/BookManageServlet?action=add" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="catalog" class="col-sm-2 col-sm-offset-2 control-label">图书类型</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label for="author" class="col-sm-2 col-sm-offset-2 control-label">图书作者</label>
				<div class="col-sm-4 ">
			...
			<div class="form-group">
				<label for="press" class="col-sm-2 col-sm-offset-2 control-label">图书出版社</label>
				<div class="col-sm-4 "> 
