...
<body>
	<h2 class="text-center">图书详情</h2>
	<div class="container">
		<div class="row">
			<div class="col-md-2 text-right">图书id</div>
			<div class="col-md-10">${bookInfo.bookId}</div>
		</div>
		<div class="row">
			<div class="col-md-2 text-right">图书名称</div>
			<div class="col-md-10">${bookInfo.bookName}</div>
		</div>
		<div class="row">
			<div class="col-md-2 text-right">图书分类</div>
			<div class="col-md-10">${bookInfo.catalog.catalogName}</div>
		</div>
		<div class="row">
			<div class="col-md-2 text-right">图书作者</div>
			<div class="col-md-10">${bookInfo.author}</div>
		</div>
		<div class="row">
			<div class="col-md-2 text-right">出版社</div>
			<div class="col-md-10">${bookInfo.press}</div>
		</div>
		<div class="row">
			<div class="col-md-2 text-right">图书价格</div>
		...
		<div class="row">
			<div class="col-md-2 text-right">图书简介</div>
