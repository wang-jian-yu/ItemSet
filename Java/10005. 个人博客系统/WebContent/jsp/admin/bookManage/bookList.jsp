...
<body>
	...
	<div class="container-fulid content">
		<div class="funbtn">
			...
			<a class="btn btn-info" href="jsp/admin/BookManageServlet?action=addReq">增加图书</a>
		</div>
					...
					<c:forEach items="${bookList}" var="i" varStatus="n">
						<tr>
							...
							<td class="noClick">
								...
								<a class="btn btn-danger btn-xs" href="jsp/admin/BookManageServlet?action=del&id=${i.bookId}" onclick="javascript:return confirm('确定要删除吗？');">删除</a>
							</td>
						</tr>
					</c:forEach>
				</c:when>
